...
- **msix_candidate**: The app is currently deployed as Win32 (or detected as a Win32 installation) and appears suitable for MSIX conversion. Criteria: no kernel drivers, no COM registration, no custom install actions, no Windows services, no shell extensions. These are straightforward conversion targets.
...
- **2 (Complex)**: Significant customisation — COM registrations, services, or shell extensions that may need workarounds
