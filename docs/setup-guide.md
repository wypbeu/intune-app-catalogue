...
- Check "MSIX candidates" and verify the readiness scores make sense
...
The flow includes a built-in daily recurrence trigger, so no additional scheduling is needed.
